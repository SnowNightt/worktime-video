...
<html lang="en">
	<head>
		...
		<meta
			...
			content="default-src 'none'; img-src ${webview.cspSource} ${devServer.baseUrl} https: data:; style-src ${webview.cspSource} 'unsafe-inline' ${devServer.baseUrl}; script-src 'nonce-${nonce}' ${devServer.baseUrl}; connect-src ${getDevServerConnectSources(devServer.baseUrl)}; font-src ${webview.cspSource} ${devServer.baseUrl};"
		/>
...
<html lang="en">
	<head>
		...
		<meta
			http-equiv="Content-Security-Policy"
			content="default-src 'none'; img-src ${webview.cspSource} https: data:; style-src ${webview.cspSource} 'unsafe-inline'; script-src 'nonce-${nonce}'; font-src ${webview.cspSource};"
		/>
